To explore the potential ethical implications of CA in a more structured manner, a distinction is made between the two types of CAs: 
\begin{enumerate}
...
%	\item Potential benefits of CA
%	\item Potential risks of CA
%	\item Ethical implications of CA
%\end{enumerate}
%The first two parts provide an insight into the possible social, economical, and technological influence of the development and application of CA technology, as well as its potential direct impact on users' physical and psychological state. Subsequently, the ethical implications of the technology are analyzed and discussed by relating to the existing ethical theories and models.
